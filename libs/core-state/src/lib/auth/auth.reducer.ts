...
import { AppState } from '@thirty-for-thirty-progress-tracker/core-state';
...
const reducer = createReducer(
  ...
  on(authenticateSuccess, (state, {user}) => ({...state, user: user.user, token: user.tokenData, authenticated: true, loading: false })),
